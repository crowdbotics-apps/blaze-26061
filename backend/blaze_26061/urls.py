...
admin.site.site_header = "Blaze"
admin.site.site_title = "Blaze Admin Portal"
admin.site.index_title = "Blaze Admin"

# swagger
api_info = openapi.Info(
    title="Blaze API",
    default_version="v1",
    description="API documentation for Blaze App",
)
